...
async def reedme(event):
    await event.edit(
        ...
        "\n[AzumiUserbot README.md file](https://github.com/levina-lab/AzumiUserbot/blob/main/README.md)"
